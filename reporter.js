...
define(function (require /*, exports, module*/) {
    ...
    Reporter.prototype.addGutterMarks = function(message, token) {
        ...
        if (!mark) {
            mark = {
                ...
                lineMarks: [],
                gutterMark: {
                    element: $("<div class='" + "coala-brackets" + "-gutter-messages' title='Click for details'>&nbsp;</div>")
                }
            };

            this.marks[token.start.line] = mark;
            mark.gutterMark.line = this.cm.setGutterMarker(token.start.line, "coala-brackets" + "-gutter", mark.gutterMark.element[0]);
        }
        ...
        if (message.type === "error") {
            mark.gutterMark.element.addClass("coala-brackets" + "-gutter-errors");
        }
    };
    ...
    Reporter.prototype.addLineMarks = function (message, token) {
        ...
        // Add line marks
        mark.lineMarks.push({
            line: this.cm.markText(token.start, token.end, {className: "coala-brackets" + "-" + message.type}),
            message: message
        });
    };
    ...
    Reporter.prototype.clearMarks = function () {
        ...
        this.cm.clearGutter("coala-brackets" + "-gutter");
